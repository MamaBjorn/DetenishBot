...
public class PhotoMessageUtils {
    ...
    public static void processingImage(String fileName, ImagesOperation operation) throws Exception {
        final BufferedImage image = org.example.utils.ImageUtils.getImage(fileName);
        final org.example.utils.RgbMaster rgbMaster = new org.example.utils.RgbMaster(image);
        rgbMaster.changeImage(operation);
        org.example.utils.ImageUtils.saveImage(rgbMaster.getImage(), fileName);
    }
}
